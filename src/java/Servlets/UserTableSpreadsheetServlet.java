 ...
 * @author Kimbreal
 */
@WebServlet(name = "UserTableSpreadsheetServlet", urlPatterns = {"/UserTableSpreadsheetServlet"})
public class UserTableSpreadsheetServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UserTableSpreadsheetServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UserTableSpreadsheetServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        OutStream out = response.getOutputStream();
        workbook.write(out);
        out.close();
    }
